            ...
            <div className={splitClasses}>
              <div className="split-item">
                <div className="split-item-content center-content-mobile">
                  ...
                  >
                    Wanna know about hospitals that are traeting covid? Find all
                    the COVID-19 hospitals near you and check for the
                    availability of the beds and ventilators. Get in contact
                    with the best one that suits your budget.
                  </p>
                  <Link
              ...
              <div className="split-item">
                <div className="split-item-content center-content-mobile">
                  ...
                  <p
                    ...
                    data-reveal-delay="100"
                  >
                    Wanna know about quarantine centres near you?
                  </p>
                  <Link
